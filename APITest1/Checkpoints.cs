    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity4_checkpoints(STActivityBase activity)
        {
            ...
            CpValObj ExpectedSchema = new CpValObj("<?xml version=\"1.0\" encoding=\"utf-16\"?><xs:schema xmlns=\"http://schemas.xmlsoap.o" +
                    ...
                    "ghts_\\webServices\\HPFlights_\\_5.xsd\" namespace=\"HP.SOAQ.SampleApp/Imports\" /><xs" +
            ...
            // Checkpoint 2
            IVTDGetter actualValueGetter2 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='DepartureCity'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject2 = new CpValObj("{DataSource.LocalDataSource.DepartureCity}", bind_dir54);
            ValueCPRule cpRule2 = new ValueCPRule(valueActualObject2, valueExpectedObject2, StringCP.EqualTo, "=", false);

            // Checkpoint 3
            IVTDGetter actualValueGetter3 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='ArrivalCity'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject3 = new CpValObj("{DataSource.LocalDataSource.ArrivalCity}", bind_dir55);
            ...
            ArrayBaseCPRule arrayAllCpRule1 = new ArrayAllCPRule("/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight']", HandlerType.XML);
            arrayElementCPRule1.AddRule(cpRule2);
            arrayElementCPRule1.AddRule(cpRule3);
            arrayAllCpRule1.AddRule(arrayElementCPRule1);
            activity.AddCheckpointRule(arrayAllCpRule1);
        }
        ...
        private void set_StServiceCallActivity6_checkpoints(STActivityBase activity)
        {
            ...
            BindDirection actualBindDirection2 = new BindDirection(_flow.StServiceCallActivity6, actualValueGetter2, actualValueSetter2);
            CpValObj valueActualObject2 = new CpValObj(actualBindDirection2, XmlTypeCode.Int, false);
            CpValObj valueExpectedObject2 = new CpValObj("1", XmlTypeCode.Int);
